...
configs:
  ...
  FirstAlliedSociety:
    description: 第一个友好部族
    is_choice: true
    choices: [" ", "蜥蜴人族：灰黨", "風精靈族：暫留地風精靈", "地靈族：第789洞穴團", "魚人族：諾布一夥", "鳥人族：長風空力團", "瓦努族：美艷的袞杜", "骨頜族：離群一族", "莫古利族：莫古利修復團", "甲人族：碧玉尋寶眾", "阿難陀族：阿露帕國境警備隊", "鯰魚精族：大鯰大祭執行委員會", "仙子族：夢園仙子", "奇塔利族：盧利採掘隊", "矮人族：沃茨之錘", "悌陽象族：河馬騎手團", "奧密克戎族：背世咖啡廳", "兔兔族：夢明工作室", "佩魯佩魯族：圖拉爾旅行公司", "Mamool Ja", "Yok Huy"]
  FirstClass:
    description: 套装名称
  SecondAlliedSociety:
    description: 第二个友好部族
...
AlliedSocietiesTable = {
    ...
    sylphs = {
        alliedSocietyName = "風精靈族：暫留地風精靈",
        questGiver        = GetNPCName(1005561), -- "特那克希亞"
    ...
    kobolds = {
        alliedSocietyName = "地靈族：第789洞穴團",
        questGiver        = GetNPCName(1005930), -- "第789團清潔工 博布"
    ...
    sahagin = {
        alliedSocietyName = "魚人族：諾布一夥",
        questGiver        = GetNPCName(1005939), -- "荷烏"
    ...
    ixal = {
        alliedSocietyName = "鳥人族：長風空力團",
        questGiver        = GetNPCName(1009201), -- "空力團貨物調度員"
    ...
    ananta = {
        alliedSocietyName = "阿難陀族：阿露帕國境警備隊",
    ...
    namazu = {
        alliedSocietyName = "鯰魚精族：大鯰大祭執行委員會",
    ...
    pelupleu = {
        alliedSocietyName = "佩魯佩魯族：圖拉爾旅行公司",
